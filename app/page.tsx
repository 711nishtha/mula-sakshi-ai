...
const STATS = [
  ...
  { value: "2.0", suffix: " Flash", label: "Gemini Model" },
...
const HOW_IT_WORKS = [
  ...
  },
  {
    ...
    description: "Gemini 2.0 Flash runs claim extraction, cross-references against government records, then generates a legal verdict.",
    color: "#D4A853",
  },
  {
    step: "03",
    ...
    <div className="min-h-screen bg-obsidian text-text-primary overflow-x-hidden">
      ...
      <footer className="py-10 px-6 md:px-10 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="text-xs text-text-muted font-body text-center">
          Google Solution Challenge 2026 · Built with Gemini 2.0 Flash · Next.js
        </div>
